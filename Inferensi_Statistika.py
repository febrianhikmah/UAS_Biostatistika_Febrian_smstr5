def uji_diagnostik():
    ...
    def menggunakan_prepro():
            ...
            # =========================
            st.subheader("📊 Estimasi Parameter Model Regresi Logistik")
            ...
            st.markdown(
                """
                Tabel di atas menunjukkan hasil estimasi parameter regresi logistik.
                Koefisien merepresentasikan arah dan besar pengaruh masing-masing variabel
                prediktor terhadap peluang kejadian batu empedu sebelum dilakukan pengujian hipotesis.
                """
            )
